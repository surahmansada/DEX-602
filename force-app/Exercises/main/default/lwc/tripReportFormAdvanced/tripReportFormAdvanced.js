...
import FIELD_NAME from
    '@salesforce/schema/TripReport__c.Name';
...
export default class TripReportFormAdvanced extends LightningElement {
    ...
    returnToBrowseMode() {
        ...
        createRecord(recordInput).then(tripReport => {
    ...
    saveTripReport() {
        ...
        //in our request
        fieldsToSave[FIELD_RATING.fieldApiName] =
            this.rating;
        fieldsToSave[FIELD_REVIEWTYPE.fieldApiName] =
            this.reviewType;
        fieldsToSave[FIELD_REVIEW.fieldApiName] =
            this.review;
        fieldsToSave[FIELD_NAME.fieldApiName] =
            this.locationName;
        if (!this.recordId) {
